...
// Copied from https://play.golang.org/p/r3VObSIB4o

var openSSLSaltHeader = "Salted_" // OpenSSL salt is always this string + 8 bytes of actual salt
...
// DecryptEnvString decrypts string that was encrypted using OpenSSL and AES-256-CBC
func DecryptEnvString(passphrase, encryptedBase64String string) ([]byte, error) {
